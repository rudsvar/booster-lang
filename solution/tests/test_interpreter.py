...
import interpreter
from interpreter import Env, InterpretException
...
class InterpreterTest(unittest.TestCase):
    ...
    def test_addition(self):
        ...
        env: Env = [{}]
        interpreter.exec_program(program, env)
        self.assertTrue(30, interpreter.lookup_var("z", env))

    def test_list(self):
        program = ProgramParser('let x = [1, "a", true];').parse_program()
        env: Env = [{}]
        interpreter.exec_program(program, env)
        self.assertTrue([1, "a", True], interpreter.lookup_var("x", env))
    ...
    def test_assignment(self):
        ...
        env: Env = [{}]
        interpreter.exec_program(program, env)
        self.assertEqual(4, interpreter.lookup_var("x", env))
    ...
    def test_fun_decl(self):
        ...
        env: Env = [{}]
        interpreter.exec_program(program, env)
        self.assertEqual(3, interpreter.lookup_var("x", env))
    ...
    def test_fun_decl_fibonacci(self):
        ...
        env: Env = [{}]
        interpreter.exec_program(program, env)
        self.assertEqual(55, interpreter.lookup_var("x", env))
    ...
    def test_fun_decl_mutual_recursion(self):
        ...
        env: Env = [{}]
        interpreter.exec_program(program, env)
        self.assertEqual(5, interpreter.lookup_var("x", env))
    ...
    def test_whilst(self):
        ...
        env: Env = [{}]
        interpreter.exec_program(program, env)
        self.assertEqual(0, interpreter.lookup_var("x", env))
